...
import { 
  Bell, Settings, User, LogOut, HelpCircle, Moon, Sun, 
...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    <header className={`w-full max-w-[1360px] h-[64px] sm:h-[72px] ${darkMode ? 'bg-gray-900' : 'bg-[#2374A5]'} rounded-lg sm:rounded-full mx-auto shadow-md flex items-center justify-center px-2 xs:px-4 sm:px-6 relative transition-colors duration-200`}>      {/* Logo - Left side */}
      <div
      ...
      >
        <Logo className="h-7 w-auto mr-2" invertColor={true} />
      </div>
